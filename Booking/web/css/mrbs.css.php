...
.dwm_main td.row_labels     {background-color:#889096; white-space: nowrap}    /* used for the row labels column */
...
table#banner {width: 100%; border-spacing: 0; border-collapse: collapse;
    ...
    border-style: solid}
#banner td {text-align: center; vertical-align: middle; background-color:#889096;
...
#banner td#company {font-size: 16px; background-color:#889096;}
...
#banner a:visited { color: <?php echo $anchor_hover_color_banner ?>; text-decoration: none; font-weight: normal}
#banner a:hover   { text-decoration:underline; font-weight: normal}
